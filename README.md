...
Default BackOffice credentials (local dev): with auto-install the image may use a default admin password (e.g. check PrestaShop Docker image docs). Change after first login.
